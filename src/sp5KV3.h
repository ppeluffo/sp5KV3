...
//----------------------------------------------------------------------------
#define SP5K_REV "1.0.0"
#define SP5K_DATE "@ 20150728"

#define SP5K_MODELO "sp5KV3 HW:avr1284P R5.0"
#define SP5K_VERSION "FW:FRTOS8"

#define EEADDR_START_PARAMS		0	// pos.inicio de datos en la EE.
//----------------------------------------------------------------------------
// Nro de canales analogicos: 3 ( OSE ).
#define CHANNELS_3
...
u08 startToken;		// Ordena como arrancan las tareas.
//------------------------------------------------------------------------------------
...
#define SECS2TERMOFF	120		// 120 segundos para apagar la terminal.
...
typedef enum { STOK_TIMERS = 1, STOK_CTL = 2, STOK_CMD = 3, STOK_EV = 4, STOK_DIN = 5, STOK_AIN = 6, STOK_OUT = 7, STOK_GPRS = 8  } t_initTokens;
typedef enum { T_COUNTER, T_VALUE, T_REMAINS, T_ISRUNNING, T_MODE } t_tparams;

#define TO2SERVICEMODE	900	// (15mins) Tiempo para salir solo del modo monitor o service
// Los timers avanzan 1tick c/100ms
#define MS_2TIMERTICKS	(1/100)
#define SEC_2TIMERTICKS	10
//------------------------------------------------------------------------------------
#endif /* SP5K_H_ */
